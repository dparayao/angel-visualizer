      ...
      <main className="flex flex-col flex-1 p-4">
        <div className="max-w-4xl mx-auto">
          ...
          <section className="mb-8">
            ...
            [0.0, 0.0, 0.0, 0.0, 0.7454545454545455, 0.0, 0.0, 0.0, 0.0, 0.2545454545454545, 0.0, 0.0]            </p>
            <p className="mb-4">
            ...
            [4, 5, 4, 5, 5, 4, 3, 5, 4, 4, 4, 5, 4, 4, 4, 6]           </p>
            <p className="mb-4">
            From this, we can see that there are sparse 3-6 notes per slice, concentrated on pitches 4 (74.5%) and 9 (25.5%). This demonstrates a Jungle bass sound, with the limited pitch range of two main notes, and a DnB bass characteristic, an irregular rhythm pattern.            </p>
            <p className="mb-4">
            Another important characteristic of Jungle/DnB are its breakbeats, which are drum patterns sampled from old funk breaks. Breakbeats are characterized by expressive, irregular timing variations which de-emphasize strong beats. (Butler, 78)            </p>
            <p className="mb-4">
            The most sampled drum break in history is from 'Amen, Brother'. It exploded in popularity in the early 1990s UK Jungle scene when producers would manipulate and pitch up to 150 -170 BPM.            </p>
            <p className="mb-4">
            ...
            <p className="mb-4">
            We can compare sound pads in the visualizer’s internet mix to a soundpad made by christhescientist. We can open the file in Audacity to view its waveform:            </p>

      ...
      <main className="flex flex-col flex-1 p-4">
        <div className="max-w-4xl mx-auto">
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">
            The internet facilitated the creation of microgenres by making music production accessible. Sites such as SoundCloud provide a platform for users to learn techniques and samples from others. For example, a DJ can comment on a timestamp to ask for the track ID. (Karnik, Mayur, et al) Although the decline of exclusivity is an annoyance for older DJs, it has allowed genre listeners to create their own innovations. Before the internet, subcultures and their music were restricted by &quot;borders, clothing, and sound&quot; - now, &quot;creativity, innovativeness, autonomy and power of the individual cultural producers&quot; lie from even within &quot;the most casual fans&quot; to the &quot;taste-makers and sub-cultural capital producers of the blogosphere.&quot; (Jia, Li) For example, YouTuber christhescientist creates tutorials for internet subgenre music such as &quot;How to Make Playstation Jungle from the 2000s.&quot; (Christhescientist)This is just one of the millions of these tutorials availale which break down tracks and teach a global audience how to modify sounds, samples and breakbeats. With a vast amount of free learning materials at their disposal, people who were previously only able to engage by listening, are now able to become subgenre innovators themselves.            
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">
            We can use the visualizer to examine how internet subgenres modified Jungle/DnB sounds.
            </p>
            <p className="mb-4">
